...
export function CheckBadgeIcon({ className = "w-5 h-5" }) {
  return (
...
export function EllipsisHorizontalIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function BuildingLibraryIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
